...
<body class="bg-gradient-to-br from-[#F5E6DA] to-[#E9A05E] min-h-screen flex items-center justify-center">
    <div class="container mx-auto px-6 flex justify-between items-center">
        ...
        <div class="w-1/2 flex justify-end">
            <img src="<?php echo e(asset('images/food-illustration.png')); ?>" alt="Food Illustration"
                class="max-w-md lg:max-w-lg transform translate-x-[-10%]"> <!-- Pindahkan gambar ke kiri -->
        </div>
    </div>

</body>
</html><?php /**PATH /Users/stefanieagahari/Herd/WD_ALP/resources/views/landing.blade.php ENDPATH**/ ?>